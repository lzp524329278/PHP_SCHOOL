...
<body>
    ...
    <script type="text/javascript" src="<?php echo HOME_PUBLIC; ?>js/jquery-1.11.1.min.js"></script>
    <script>
        function ajax_delete_shoppingcart(id) {
        do_ajax('get', "/PHP_SCHOOL/code/index.php/Home/Shoppingcart/index" + "?func=delete&id=" + id, null, function(data){
        eval('var result=' + data);
        if (result.result){
        document.getElementById('shoppingcart' + id).innerHTML = '';
        ...
        function ajax_change_shoppingcart(id, num) {
        do_ajax('get', "/PHP_SCHOOL/code/index.php/Home/Shoppingcart/index" + "?func=change&id=" + id + "&num=" + num, null, function(data){
        console.log(data);
        eval('var result=' + data);
        if (result.result){
        //console.log(id);
        ...
        if (event.keyCode == 13)
        {
        ajax_change_shoppingcart(id, num);
        return false;
        }
        }
        function ajax_delete_all_shoppingcart(){
        do_ajax('get', "/PHP_SCHOOL/code/index.php/Home/Shoppingcart/index" + "?func=deleteall", null, function(data){
        eval('var result=' + data);
        if (result.result){
       // document.getElementById('all_shopping_cart').innerHTML = '';
       $("#shppingcart_th").siblings().remove();
        document.getElementById('total_price').innerHTML = result.total_price;
        document.getElementById('total_price2').innerHTML = "购物金额小计 ￥" + result.total_price;
        }
        });
            ...
            <div class="flowBox">
                ...
                <form id="formCart" name="formCart" >
                    <table class="table table-bordered" width="99%" align="center" border="1" cellpadding="215" cellspacing="11" bgcolor="#dddddd">
                        ...
                        <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id='shoppingcart<?php echo ($vo["id"]); ?>'>
                                ...
                                <td align="center" bgcolor="#ffffff" style="vertical-align: inherit;">
                                    <a href="javascript:void(0)" onclick="ajax_delete_shoppingcart(<?php echo ($vo["id"]); ?>)" class="f6">删除</a>
                                </td>
                    ...
                    <table class="table table-bordered" width="99%" align="center" border="1" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
                        ...
                        <td align="right" bgcolor="#ffffff">
                            <input type="button" value="清空购物车" class="bnt_blue_1" onclick="ajax_delete_all_shoppingcart()" />
                            <!--                            <input name="submit" type="submit" class="bnt_blue_1" value="更新购物车" onkeydown="return clickButton()" onclick="return ajax_change_shoppingcart();" />-->
                        </td>
                        </tr>
                    </table>
                </form>
                <table width="99%" align="center" border="0" cellpadding="5" cellspacing="0" bgcolor="#dddddd">
                    <tr>
                        ...
                        <td bgcolor="#ffffff" align="right"><a href="/PHP_SCHOOL/code/index.php/Home/Shoppingcart/buy"><img src="<?php echo HOME_PUBLIC; ?>images/checkout.png" alt="checkout" /></a></td>
                    </tr>
                </table>
            </div>
        </div>
