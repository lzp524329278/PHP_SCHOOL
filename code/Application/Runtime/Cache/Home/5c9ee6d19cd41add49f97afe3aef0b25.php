	...
	<div class="container">
	    <div class="register">
			   <div class="col-md-6 login-left">
				 ...
				 <a class="acount-btn" href="javascript:ajax_get_register(1)">注册</a>
			   </div>
				...
				<form name='login_form' onsubmit="return false;">
				  <div>
					<span>用户名<label>*</label></span>
                                        <input type="text" name="user_id"  onkeypress="return stopEnter()"/>
				  </div>
				  <div>
					<span>密码<label>*</label></span>
					<input type="password" name="password"  onkeypress="return stopEnter()"/>
				  </div>
				  <a class="forgot" href="javascript:ajax_get_reset()">忘记密码?&nbsp;</a>
